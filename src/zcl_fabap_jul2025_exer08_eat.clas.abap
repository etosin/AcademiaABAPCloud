CLASS zcl_fabap_jul2025_exer08_eat DEFINITION
  PUBLIC
  CREATE PUBLIC .

  PUBLIC SECTION.

    METHODS constructor IMPORTING iv_nome TYPE string iv_id TYPE string iv_salario_base TYPE decfloat16.
  ...
  PROTECTED SECTION.
    DATA: mv_nome         TYPE string,
          mv_id           TYPE string,
          mv_salario_base TYPE decfloat16.
...
CLASS ZCL_FABAP_JUL2025_EXER08_EAT IMPLEMENTATION.
